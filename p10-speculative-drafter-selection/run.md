# How to Run — P10: Dynamic Heterogeneous Drafter Selection for Speculative Decoding
...
```bash
cd p10-speculative-drafter-selection
python -m venv .venv
...
arXiv:2604.05417, arXiv:2512.23765 (training-free variants)
