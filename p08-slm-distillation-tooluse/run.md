# How to Run — P8: Step-Wise On-Policy Distillation for Small Reasoning Models (Tool Use)
...
```bash
cd p08-slm-distillation-tooluse
python -m venv .venv
...
SOD (arXiv:2605.07725), LIMO/S1K lessons, Phi-4-Mini-Reasoning
