#!/usr/bin/env python3
"""
Main entry point for P6: Context-Length-Induced Degradation Under Perfect Retrieval
"""
import argparse
import os
import sys
...
from src.core import ContextDegradationProbe as ProblemProbe  # P6 specific
...
def main():
    ...
    if args.smoke_test:
        ...
        reordered = model.suggest_reorder(positions, out["degradation_score"])
        print(f"Demo reorder suggestion: orig {positions} -> {reordered}")
